...
import pl.raspi.dashboard.service.filters.InvoiceByCompanyFilter;
...
@RestController
public class InvoiceControllerMulticompanies extends AbstractController<LoadEntryHeader> {
