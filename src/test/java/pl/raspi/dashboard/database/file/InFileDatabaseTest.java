...
public class InFileDatabaseTest extends DatabaseTest {
  ...
  private Configuration config = new Configuration(LoadEntryHeader.class.getSimpleName());
  ...
  public Database getCleanDatabase() {
    ...
    Database database = new InFileDatabase<LoadEntryHeader>(LoadEntryHeader.class, "\"invoiceId\"");
    return database;
  }
  ...
  public void shouldAddInvoiceCorrectlyAfterDbReinitialization() {
    ...
    //when
    Database dbInstance = new InFileDatabase<LoadEntryHeader>(LoadEntryHeader.class, "\"invoiceId\"");
