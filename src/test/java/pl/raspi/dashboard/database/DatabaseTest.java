...
public abstract class DatabaseTest {
  ...
  protected LoadEntryHeader givenInvoice;
  protected Database givenDatabase;
  protected long[] invoiceIds = new long[INVOICES_COUNT];
  private ObjectMapperHelper mapper = new ObjectMapperHelper<LoadEntryHeader>(LoadEntryHeader.class);
  ...
  public void shouldGetAllInvoices() {
    //then
    ArrayList<LoadEntryHeader> allInvoices = new ArrayList<>(givenDatabase.getEntries());
